...
for ((seed=0; seed<15; seed+=1)); do
    ...
    --img_size=32 --memory_size="$memory_size" --learning_mode='online' --run_name="contrastive_divergence_memory_($memory_size)_with_aug_lr_5e-04_alpha_2.0_beta_2.0_seed_($seed)_with_rep_loss" --alpha=2.0 --beta=2.0 --seed="$seed"
done
